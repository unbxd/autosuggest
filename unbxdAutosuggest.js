    ...
    window.autoSuggestObj = $.extend(autocomplete.prototype, {
        default_options: {
            ...
            popularProducts: {
                ...
                header: "",
                view: 'list',
                tpl: ['{{#if ../showCarts}}', '{{#unbxdIf ../../cartType "inline"}}' //"inline" || "separate"
                    , '<div class="unbxd-as-popular-product-inlinecart">', '<div class="unbxd-as-popular-product-image-container">', '{{#if image}}', '<img src="{{image}}" alt="{{autosuggest}}"/>', '{{/if}}', '</div>', '<div  class="unbxd-as-popular-product-name popular-title">', '<div style="table-layout:fixed;width:100%;display:table;">', '<div style="display:table-row">', '<div style="display:table-cell;text-overflow:ellipsis;overflow: hidden;white-space: nowrap;">', '{{{safestring highlighted}}}', '</div>', '</div>', '</div>', '</div>', '{{#if price}}', '<div class="unbxd-as-popular-product-price">', '{{#if salePrice}}', '<span class="regular-price">', '{{currency}}{{price}}', '</span>', '<span class="unbxd-as-discount">', '{{currency}}{{salePrice}}', '</span>', '{{else}}', '{{currency}}{{price}}', '{{/if}}', '</div>', '{{/if}}', '<div class="unbxd-as-popular-product-quantity">', '<div class="unbxd-as-popular-product-quantity-container">', '<span>Qty</span>', '<input class="unbxd-popular-product-qty-input" value="1"/>', '</div>', '</div>', '<div class="unbxd-as-popular-product-cart-action">', '<button class="unbxd-as-popular-product-cart-button">Add to cart</button>', '</div>', '</div>', '{{else}}', '<div class="unbxd-as-popular-product-info">', '<div class="unbxd-as-popular-product-image-container">', '{{#if image}}', '<img src="{{image}}" alt="{{autosuggest}}"/>', '{{/if}}', '</div>', '<div>', '<div  class="unbxd-as-popular-product-name popular-title">', '{{{safestring highlighted}}}', '</div>'

                    , '<div class="unbxd-as-popular-product-cart">', '<div class="unbxd-as-popular-product-cart-action">', '<button class="unbxd-as-popular-product-cart-button">Add to cart</button>', '</div>', '<div class="unbxd-as-popular-product-quantity">', '<div class="unbxd-as-popular-product-quantity-container">', '<span>Qty</span>', '<input class="unbxd-popular-product-qty-input" value="1"/>', '</div>', '</div>', '{{#if price}}', '<div class="unbxd-as-popular-product-price">', '{{#if salePrice}}', '<span class="regular-price">', '{{currency}}{{price}}', '</span>', '<span class="unbxd-as-discount">', '{{currency}}{{salePrice}}', '</span>', '{{else}}', '{{currency}}{{price}}', '{{/if}}', '</div>', '{{/if}}', '</div>', '</div>', '</div>', '{{/unbxdIf}}', '{{else}}', '<div class="unbxd-as-popular-product-info">', '<div class="unbxd-as-popular-product-image-container">', '{{#if image}}', '<img src="{{image}}" alt="{{autosuggest}}"/>', '{{/if}}', '</div>', '<div  class="unbxd-as-popular-product-name popular-title">', '{{{safestring highlighted}}}', '</div>', '{{#if price}}', '<div class="unbxd-as-popular-product-price">', '{{#if salePrice}}', '<span class="regular-price">', '{{currency}}{{price}}', '</span>', '<span class="unbxd-as-discount">', '{{currency}}{{salePrice}}', '</span>', '{{else}}', '{{currency}}{{price}}', '{{/if}}', '</div>', '{{/if}}', '</div>', '{{/if}}'
                ].join(''),
                viewMore: {
                    enabled: false,
                    tpl: "",
