...
var unbxdAutocomplete = (function () {
	...
	var _CONST = {
		...
		autoCompltInClass : "unbxd-autocomplete-list-li-in",
	...
	var _ui = {
		...
		buildCategory : function(hint, styles, value, key){
			if (hint) {
				var filter 	= hint,
					key 	= key,
				    hint 	= this.buildElem('<li value="'+value+'" filter="'+filter+'"  key="'+key+'" class="' + _CONST.autoCompltInClass  +' '+ _CONST.autoCompltHintClass + '">&nbsp;&nbsp;&nbsp;&nbsp;in&nbsp; <span value="'+value+'" filter="'+filter+'"  key="'+key+'" class="' + _CONST.autoCompltHintClass + '">' + hint + '</span></li>');
